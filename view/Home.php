...
class Home extends TwigView {
    public function show($datos) {
        ...
        echo self::getTwig()->render('header.twig.html', array('iniciar_sesion' => $iniciar_sesion , 'usuario' => unserialize($_SESSION['usuario']) , 'administrador' => $_SESSION['administrador'] , 'recepcionista' => $_SESSION['recepcionista'] , 'pediatra' => $_SESSION['pediatra']));        
